  ...
  <div>
    ...
    <div class="lg:pl-72">
      ...
      >
        ...
        <div
          class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 bg-white dark:bg-gray-900"
        >
          <form class="relative flex flex-1" action="#" method="GET">
            <label for="search-field" class="sr-only">Search</label>
            <MagnifyingGlassIcon
              class="pointer-events-none absolute inset-y-0 left-0 h-full w-5 text-gray-400 dark:text-white"
              aria-hidden="true"
            />
            <input
              id="search-field"
              class="block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 dark:text-white placeholder:text-gray-400 focus-visible:!outline-none active:outline-none sm:text-sm light:bg-white dark:!bg-gray-900"
              placeholder="Search..."
              type="search"
              name="search"
            />
      ...
      >
        <div class="px-4 sm:px-6 lg:px-8 h-screen">
