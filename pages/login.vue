...
<template>
  <div
    class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8 bg-white dark:bg-gray-900 dark:!text-white text-gray-900"
  >
      ...
      >
        ...
        <div>
          <div class="relative mt-10">
            ...
            >
              <span class="bg-white px-6 text-gray-900 rounded-md"
